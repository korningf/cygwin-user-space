...
#define MODULES_INIT_DIR "/usr/local/Modules/3.2.10/init"
...
/* PHOSTNAME: Last resort to get the hostname, if uname() and gethostname()
   are not available. */
#define PHOSTNAME "/usr/bin/hostname"

/* PREFIX: Usually equivalent to /usr/local/Modules[/version_number] */
#define PREFIX "/usr/local/Modules/3.2.10"
